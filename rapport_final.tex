...
\begin{itemize}[leftmargin=*,topsep=2pt]
    \item \texttt{weibull\_final.ipynb} : notebook complet, ré-exécutable
    \item \texttt{presentation\_weibull.pptx} : présentation orale (22 slides)
    \item \texttt{plot\_ppt/} : tous les graphiques en PNG haute résolution
